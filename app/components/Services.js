  ...
  return (
    <div className="flex flex-col justify-center items-center my-40">
      ...
      <div className="relative">
        <Image src={services} className="mt-10 mx-auto" />
        <Image
          src={towel}
        ...
        <div
          className="flex flex-col w-full px-4 lg:flex-row lg:w-auto justify-center mx-auto lg:mx-0 items-center text-center lg:absolute lg:top-30 2xl:top-40 lg:left-1/2 lg:transform lg:-translate-x-1/2 gap-4 mt-20 lg:mt-0
"
        >
        ...
        <div
          className="flex flex-col w-full gap-4 px-4 lg:flex-row lg:w-auto justify-center lg:absolute lg:bottom-30 2xl:bottom-25 lg:left-1/2 lg:transform lg:-translate-x-1/2 items-center text-center
"
        >
